"""autogenerated by genpy from benchmark_manipulation_tests/GetMobileArmPlanRequest.msg. Do not edit."""
import sys
...
class GetMobileArmPlanRequest(genpy.Message):
  _md5sum = "9e3f9d9cc08f18e0f194fec8a7021fd8"
  _type = "benchmark_manipulation_tests/GetMobileArmPlanRequest"
...
"""
  __slots__ = ['start','underspecified_start','planning_mode','allocated_planning_time','rarm_start','larm_start','body_start','rarm_goal','larm_goal','body_goal','goal','xyz_tolerance','roll_tolerance','pitch_tolerance','yaw_tolerance','rarm_object','larm_object','initial_eps','final_eps','dec_eps','planner_type','meta_search_type','mha_type','use_ompl']
  _slot_types = ['geometry_msgs/PoseStamped','bool','int8','float64','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','geometry_msgs/PoseStamped','float64','float64','float64','float64','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped','float64','float64','float64','int8','int8','int8','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       start,underspecified_start,planning_mode,allocated_planning_time,rarm_start,larm_start,body_start,rarm_goal,larm_goal,body_goal,goal,xyz_tolerance,roll_tolerance,pitch_tolerance,yaw_tolerance,rarm_object,larm_object,initial_eps,final_eps,dec_eps,planner_type,meta_search_type,mha_type,use_ompl
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_10d3bB.pack(_x.larm_object.pose.position.x, _x.larm_object.pose.position.y, _x.larm_object.pose.position.z, _x.larm_object.pose.orientation.x, _x.larm_object.pose.orientation.y, _x.larm_object.pose.orientation.z, _x.larm_object.pose.orientation.w, _x.initial_eps, _x.final_eps, _x.dec_eps, _x.planner_type, _x.meta_search_type, _x.mha_type, _x.use_ompl))
...
_struct_10d3bB = struct.Struct("<10d3bB")
_struct_7d3I = struct.Struct("<7d3I")
"""autogenerated by genpy from benchmark_manipulation_tests/GetMobileArmPlanResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetMobileArmPlanResponse(genpy.Message):
  ...
  _type = "benchmark_manipulation_tests/GetMobileArmPlanResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
...
class GetMobileArmPlan(object):
  _type          = 'benchmark_manipulation_tests/GetMobileArmPlan'
  _md5sum = '12a4d236c9c8e3a5481f6849b74076d8'
