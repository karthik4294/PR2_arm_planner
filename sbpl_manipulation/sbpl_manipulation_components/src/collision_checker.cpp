...
{
  ROS_ERROR("Function isStateValid is not filled in.");
  return false;
}
...
{
  ROS_ERROR("Function isStateValid-2 is not filled in.");
  return false;
}
...
{
  ROS_ERROR("Function isStateToStateValid is not filled in.");
  return false;
}
...
{
  ROS_ERROR("Function isStateToStateValid-2 is not filled in.");
  return false;
}
