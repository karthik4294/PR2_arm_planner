...
class EGraphEuclideanHeuristic : public EGraphHeuristic<std::vector<double> >{
  public:
    ...
    EGraphEuclideanHeuristic(const EGraphEuclideanHeuristic& other) : env_(other.env_){
      dist_inflation = other.dist_inflation;
      eg_ = NULL;
      epsE_ = other.epsE_;
      inflation.clear();
  ...
  protected:
    ...
    std::multimap<std::vector<int>, EGraph::EGraphVertex*> snap_table;
};
